...
export default function SocialShareButtons({ slug }) {
            ...
            <ul className="social-link">
              <li>
                <a
                  ...
                  href={`https://facebook.com/sharer/sharer.php?u=${baseUrl}/course/${slug}`}
                  className="d-block"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <li>
                <a
                  style={{ backgroundColor: "transparent" }}
                  href={`https://twitter.com/intent/tweet?url=${baseUrl}/course/${slug}`}
                  className="d-block"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <li>
                <a
                  style={{ backgroundColor: "transparent" }}
                  href={`https://pinterest.com/pin/create/button/?url=${baseUrl}/course/${slug}`}
                  className="d-block"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <li>
                <a
                  style={{ backgroundColor: "transparent" }}
                  href={`https://www.linkedin.com/shareArticle?mini=true&url=${baseUrl}/course/${slug}`}
                  className="d-block"
                  target="_blank"
                  rel="noreferrer"
                >
